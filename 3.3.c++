...
/*
可以对一个设置一个材质struct，里面盛放以下属性：
vec3 ambient	材质的环境光照
vec3 diffuse	材质的漫反射光照
vec3 specular	材质的镜面反射光照
float shininess	反光度
vec3 ambientIntensity	环境光照强度
vec3 diffuseIntensity	漫反射光照强度
vec3 specularIntensity	镜面反射光照强度
其中前四个属性影响材质的种类，各种材质都有特定的值，请自行查询，后三个属性反映了不同光照属性对整体效果的影响力度
举个例子：银材质的前四个属性值分别为(0.19225,0.19225,0.19225)	(0.50754,0.50754,0.50754)	(0.508273,0.508273,0.508273)	0.4
*/
//https://cs.wellesley.edu/~cs307/readings/OpenGL-VRML-Materials.html
//你也可以通过将lightColor或者objectColor设置成随时间变化的函数来取得更加花哨的效果
//设置一个骚气的红色
...
"FragColor=vec4(0.5*diff*(material.diffuse)+0.2*material.ambient+spec*material.specular)*lightColor*objectColor,1.0);\n"
"}\0";
...
int main()
{
	...
	glUniform3f(glGetUniformLocation(SP, "material.ambient"),1,GL_FALSE, (0.19225f,0.19225f,0.19225f));
	glUniform3f(glGetUniformLocation(SP, "material.diffuse"), 1, GL_FALSE, (0.50754, 0.50754, 0.50754));
	glUniform3f(glGetUniformLocation(SP, "material.specular"), 1, GL_FALSE, (0.508273, 0.508273, 0.508273));
	glUniform1f(glGetUniformLocation(SP, "material.shininess"),0.4f);
